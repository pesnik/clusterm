...
def run_git_operations(version: str):
    ...
    try:
        ...
        print(f"✅ Git operations completed:")
...
def main():
    ...
    try:
        ...
        if run_git_operations(new_version):
            ...
            print(f"   2. Push to remote: git push origin main --tags")
            print(f"   3. Create GitHub release (optional)")
            print(f"   4. Deploy to production (if applicable)")
        else:
