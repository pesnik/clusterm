...
class LiveCompletionProvider:
    ...
    def get_completions(self, resource_type: str, context: Optional[str] = None) -> List[str]:
    ...
    def get_resource_names(self, resource_type: str, namespace: Optional[str] = None) -> List[str]:
    ...
    def get_helm_releases(self, namespace: Optional[str] = None) -> List[str]:
        """Get Helm release names"""
        self._refresh_if_needed()
        return self.cache.data.get('helm_releases', [])
    
    def get_container_names(self, pod_name: str, namespace: Optional[str] = None) -> List[str]:
